...
3- test sur device connecté
    ...
    lancer la commande : adb devices 
    (doit demander une autorisation sur le téléphone et afficher l'id du périphérique suivi de "device" dans la console)
...
5- debug avec Phonegap Developer app
    ...
    > L'application se lance dans le téléphone
